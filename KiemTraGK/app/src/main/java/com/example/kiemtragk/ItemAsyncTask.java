...
public class ItemAsyncTask extends AsyncTask<String, Void, JSONObject> {
    private IViewItem mView;
    private Map<String, String> mMap;

    public ItemAsyncTask(IViewItem iView) {
        this.mView = iView;
    }

    public ItemAsyncTask(IViewItem mView, Map<String, String> mMap) {
        this.mView = mView;
        this.mMap = mMap;
    }
