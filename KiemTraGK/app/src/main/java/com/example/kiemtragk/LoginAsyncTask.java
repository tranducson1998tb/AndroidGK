...
public class LoginAsyncTask extends AsyncTask<String,Boolean, JSONObject> {
    ...
    public LoginAsyncTask(Context context, IViewLogin iLoginView, Map<String,String> map){
        this.mMap = map;
    ...
    protected void onPostExecute(JSONObject jsonObject) {
        if (jsonObject != null){
            try {
                ...
                JSONObject jsonChild = jsonObject.getJSONObject( "response_data" );
                if(jsonChild != null){
                    int mUserID = jsonChild.getInt( "user_id" );
                    sqLite.insertLogin( mUserID );
                }
